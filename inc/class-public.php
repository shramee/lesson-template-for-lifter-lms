...
class Lesson_Template_LLMS_Public {
	 ...
	 * @return string
	 */
	public function syllabus_section_link( $title, $section = null ) {
		if ( $section ) {
			$link = get_permalink( $section->get_lessons()[0]->get( 'id' ) );

			return "<a style='color:inherit;' href='$link'>$title</a>";
		}
	...
	public function lesson_markup() {
		echo '<div id="lesson"><div id="lesson-primary" class="content-area grid-parent mobile-grid-100 grid-65 tablet-grid-65">';
	}
	...
	public function lesson_markup_sidebar() {
		echo '<div id="right-sidebar" role="complementary" class="widget-area grid-35 tablet-grid-35 grid-parent sidebar">';
	}
	...
	public function course_index() {
		...
		<div class="index">
			<div class="index-tabs">
				<a href="#index-section" data-title="Section: <?php echo $section->get( 'title' ) ?>" class="button active">Section
					lessons</a>
			...
			<div class="index-tabs-content">
				...
				<div id="index-tab-title" class="button bottom-fix">Section: <?php echo $section->get( 'title' ) ?></div>
			</div>
		</div>
		<?php
	}
	...
	public function course_progress() {
		...
		<div id="llms-course-progress" class="button llms-progress">
			...
			<span class="progress-bar">
				<span class="progress-bar-complete <?php echo $progress > 95 ? 'almost-done' : '' ?>"
